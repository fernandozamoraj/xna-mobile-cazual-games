...
namespace CazualGamesDemo.Screens
{
    public class StartScreen : DemoScreenBase
    {
        ...
        private void HandleButtonInputs()
        {
            ...
            if(_dumbMonkeyScreenButton.IsPressed)
                NavigateToScreen<DumbMonkeyScreen>();
        }
        ...
        private void UpdateButtons()
        {
            ...
            _dumbMonkeyScreenButton.Update();
        }
        ...
        public override void Initialize()
        {
            ...
            _dumbMonkeyScreenButton = new Button(new Vector2(xPosition, 100 + (deltayY * 3)), (int)(_tutorialsButtonTexture.Width * 1.5), (int)(_tutorialsButtonTexture.Height * 1.5), true);
        ...
        public override void LoadContent(ContentManager content)
        {
            ...
            _dumbMonkeyButtonTexture = content.Load<Texture2D>("tutorial");
        }
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            _dumbMonkeyScreenButton.Draw(spriteBatch, _dumbMonkeyButtonTexture);
